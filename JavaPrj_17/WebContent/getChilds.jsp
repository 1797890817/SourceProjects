<%@ page language="java" pageEncoding="gb2312" import="com.sanqing.course.model.*, com.sanqing.course.util.*,java.util.*" %>
<%
	...
	buf.append("document.courseScheduleForm.teacherId.options[0].text = '--ÇëÑ¡Ôñ--';\n");
